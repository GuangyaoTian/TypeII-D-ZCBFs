...
T = 0.1 
N = 30 
N_1=30 ### steps for obstacle avoid
...
while not flag: 
    if current_target_index<1 :
        obsnumis=0
        xs = target_points[current_target_index] ### different target points 
        start_time = time.time()

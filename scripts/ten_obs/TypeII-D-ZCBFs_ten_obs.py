...
def scan_callback(msg):
    ...
    if points_array.size == 0: ### no obstacle can be found in Lidar
        num_ellipses = 0  
        ellipse_arrays = []  
        return  
    ###DBSCAN
...
### target points (in this code three points)
target_points = [
...
while not flag: 
    if current_target_index<3 :
        ...
        ### get the input from the MPC only (cannot avoid the obstacle)
